package com.example.alarm.helper;
...
public class TinyDB {
    ...
    public ArrayList<VeriModeli> getListObject(String key, Class< ? > mClass){
        Gson gson = new Gson();

        ArrayList< String > objStrings = getListString(key);
        ArrayList< VeriModeli > objects =  new ArrayList< VeriModeli >();

        mClass = VeriModeli.class;
        for(String jObjString : objStrings){
            VeriModeli value  = (VeriModeli) gson.fromJson(jObjString,  mClass);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putListObject(String key, List<VeriModeli> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
